...
# microarchitecture. This is the same qualified audit used by the 1.2.2 release.
python3 - <<'PYOP'
...
p=Path('build/complete123/operator_span_122.sh')
...
src=src.replace('./test_operator_span_mature_1011.sh','sh build/complete123/operator_span_122.sh')
