...
# 6. Existing 1.0.15 hot-kernel machine code is frozen for this semantic-only
# release.  This is stronger than a noisy timing comparison.
build/topologyc tests/topology_cases/heat_diffusion_step_tolerant.wh -o build/semantic110/heat_baseline >/dev/null
[ "$(sha256sum build/semantic110/heat_baseline | awk '{print $1}')" = '76404fbc1a3b54c7b829a01f44e4716ebcf6db3ec7b441504636e4c5a8c2e0ab' ]
[ "$(build/semantic110/heat_baseline 16777216)" = 'checksum_bits=0x4167fc0000000000' ]
echo 'WHEX_1_0_15_MACHINE_CODE_BASELINE_PRESERVED=PASS'
...
echo 'WHEX_GENERAL_TRUE_PARALLEL_SEMANTICS_1_1_0=PASS'
