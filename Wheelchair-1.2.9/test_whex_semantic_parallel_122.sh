...
# The derived script lives under build/, so keep its runtime root anchored to the
# already-entered release tree instead of deriving ROOT from its temporary path.
