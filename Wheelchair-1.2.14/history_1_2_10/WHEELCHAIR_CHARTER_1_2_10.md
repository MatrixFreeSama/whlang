# Wheelchair 1.2.10 General Physicalization Charter

## Status

This is the authoritative 1.2.10 amendment to the 1.2.9 recipient-blind resource charter. All 1.2.9 prohibitions remain in force. 1.2.10 changes physicalization cost, not resource-release semantics.
...
The final 1.2.10 production path adds a native x86-64 surface lowerer and native launcher. Python is not part of source parsing, AOT causality planning, causal-region physicalization, backend emission, runtime execution, or release-resource semantics.
