...
./build.sh > .release_build_1213.log 2>&1
grep -q 'PRODUCTION_BUILD_PYTHON_INVOCATIONS=0' .release_build_1213.log
grep -q 'GENERAL_PARALLEL_BLIND_RESOURCE_RELEASE=PASS' .release_build_1213.log
grep -q 'WHEELCHAIR_1_2_13_NATIVE_PROFILE_SELECTOR=BUILT' .release_build_1213.log
...
TMP=${TMPDIR:-/tmp}/wheelchair1213_release_$$
mkdir -p "$TMP"
...
echo 'WHEELCHAIR_1_2_13_RELEASE=PASS'
